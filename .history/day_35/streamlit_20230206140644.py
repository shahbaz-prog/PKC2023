...
fig_preg = plt.figure()
dimension1 = sns.scatterplot(x= "age", y = "chol", data = df1 , hue= "output",palette = "dark")
dimension2 = sns.scatterplot(x = user_data["age"], y = user_data["chol"], s=150, color = color, bins = 10)
plt.xticks(np.arange(10,100,3))
