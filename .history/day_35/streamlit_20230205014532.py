...
def user_input_features():
    ...
    chol = st.sidebar.slider("trtbps", min_value_2, max_value_2, value=None, step=None, format=None)
    fbs = st.sidebar.slider("fbs", 1.0,2.0,3.0)
    restecg = st.sidebar.slider("restecg", 0.0,1.0)
    thalach = st.sidebar.slider("thalach", min_value_3, max_value_3, value=None, step=None, format=None)
    exng = st.sidebar.slider("exng", 0.0,1.0)
    oldpeak = st.sidebar.slider("exng", min_value_4, max_value_4, value=None, step=None, format=None)
    slp = st.sidebar.slider("exng", 0.0,1.0,2.0)
    caa = st.sidebar.slider("exng", 0.0,1.0,2.0,3.0,4.0)
    thall = st.sidebar.slider("exng", 0.0,1.0,2.0,3.0)
